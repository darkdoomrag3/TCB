    ...
    <div className={classes.root}>
      <Grid container spacing={3}>
        ...
        <Grid item xs={6} sm={6} md={6} lg={8}>
          <Grid item md={12}>
            <a className={classes.typography} style={{marginLeft: 10,fontWeight: 500}} href="#">همه
        ...
        spacing={2}
          ...
          <Hidden only smDown ><Grid item md={6} lg={3}>
          <Item>
            <Card style={{borderRadius: 15}}>
              <CardMedia
                component="img"
          ...
          <Hidden only mdDown ><Grid item md={4} lg={3}>
          <Item>
            <Card style={{borderRadius: 15}}>
              <CardMedia
                component="img"
        ...
        spacing={2}
          ...
          <Hidden only mdDown ><Grid item sm={6} md={4} lg={3}>
          <Item>
            <Card style={{borderRadius: 15}}>
              <CardMedia
              className={classes.imageStyle}
